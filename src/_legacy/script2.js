 ...
 * Texture
 */
const canShadowOpacityTexture = textureLoader.load('/texture/room/canShadowOpacity.webp')
canShadowOpacityTexture.flipY = false

const gunShadowOpacityTexture = textureLoader.load('/texture/room/gunShadowOpacity.webp')
...
gltfLoader.load(
	...
	(gltf) =>
	{
		...
		pointerInstancedMesh = interactionObjects.pointerGroup
	...
	if(interactionObjects.laptopScreen)
	{
		...
		if(intersection.length > 0)
		{
			...
			const testIntersections = testRaycaster.intersectObjects([
				laptopScreen.intersectObjects.sectionGroup.sectionAppearance,
				laptopScreen.intersectObjects.sectionGroup.sectionEvent,
				laptopScreen.intersectObjects.sectionGroup.sectionProfile,
				laptopScreen.intersectObjects.textMission,

			])
			if(testIntersections.length > 0)
			{
				//laptopScreen.intersectObjects.textBoxGroup.textBoxAppearance.visible = true
				...
				//laptopScreen.intersectObjects.textBoxGroup.textBoxAppearance.visible = false
				for(let key in laptopScreen.intersectObjects.textBoxGroup)
				{
